...
class Metaclass_MessageTurtleCommands_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('actions_help')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'actions_help.action.MessageTurtleCommands_Goal')
            logger.debug(
...
class Metaclass_MessageTurtleCommands_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_help.action.MessageTurtleCommands_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MessageTurtleCommands_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_help.action.MessageTurtleCommands_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MessageTurtleCommands_SendGoal_Request(metaclass=Metaclass_MessageTurtleCommands_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'actions_help/MessageTurtleCommands_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['actions_help', 'action'], 'MessageTurtleCommands_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from actions_help.action._message_turtle_commands import MessageTurtleCommands_Goal
...
class Metaclass_MessageTurtleCommands_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_help.action.MessageTurtleCommands_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from actions_help.action import _message_turtle_commands
...
class MessageTurtleCommands_SendGoal(metaclass=Metaclass_MessageTurtleCommands_SendGoal):
    from actions_help.action._message_turtle_commands import MessageTurtleCommands_SendGoal_Request as Request
    from actions_help.action._message_turtle_commands import MessageTurtleCommands_SendGoal_Response as Response
...
class MessageTurtleCommands_GetResult_Response(metaclass=Metaclass_MessageTurtleCommands_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'actions_help/MessageTurtleCommands_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['actions_help', 'action'], 'MessageTurtleCommands_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from actions_help.action._message_turtle_commands import MessageTurtleCommands_Result
...
class Metaclass_MessageTurtleCommands_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_help.action.MessageTurtleCommands_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MessageTurtleCommands_GetResult(metaclass=Metaclass_MessageTurtleCommands_GetResult):
    from actions_help.action._message_turtle_commands import MessageTurtleCommands_GetResult_Request as Request
    from actions_help.action._message_turtle_commands import MessageTurtleCommands_GetResult_Response as Response
...
class Metaclass_MessageTurtleCommands_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_help.action.MessageTurtleCommands_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MessageTurtleCommands_FeedbackMessage(metaclass=Metaclass_MessageTurtleCommands_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'actions_help/MessageTurtleCommands_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['actions_help', 'action'], 'MessageTurtleCommands_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from actions_help.action._message_turtle_commands import MessageTurtleCommands_Feedback
...
class Metaclass_MessageTurtleCommands(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_help.action.MessageTurtleCommands')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MessageTurtleCommands(metaclass=Metaclass_MessageTurtleCommands):
    ...
    from actions_help.action._message_turtle_commands import MessageTurtleCommands_Goal as Goal
    # The result message defined in the action definition.
    from actions_help.action._message_turtle_commands import MessageTurtleCommands_Result as Result
    # The feedback message defined in the action definition.
    from actions_help.action._message_turtle_commands import MessageTurtleCommands_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from actions_help.action._message_turtle_commands import MessageTurtleCommands_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from actions_help.action._message_turtle_commands import MessageTurtleCommands_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from actions_help.action._message_turtle_commands import MessageTurtleCommands_FeedbackMessage as FeedbackMessage
